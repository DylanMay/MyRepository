...
public class FragmentActivity extends Activity
{
  ...
  public View onCreateView(String paramString, Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    {
      return localView;
      String str1 = paramAttributeSet.getAttributeValue((String)localObject, "class");
      TypedArray localTypedArray = paramContext.obtainStyledAttributes(paramAttributeSet, FragmentTag.Fragment);
      if (str1 == null)
        str1 = localTypedArray.getString(i);
      ...
      if (j != -1)
        localObject = this.mFragments.findFragmentById(j);
      ...
      if (FragmentManagerImpl.DEBUG)
        Log.v("FragmentActivity", "onCreateView: id=0x" + Integer.toHexString(j) + " fname=" + str1 + " existing=" + localObject);
      int k;
      if (localObject == null)
      {
        localObject = Fragment.instantiate(this, str1);
        ((Fragment)localObject).mFromLayout = true;
        if (j != 0)
        {
          k = j;
          ((Fragment)localObject).mFragmentId = k;
          ((Fragment)localObject).mContainerId = i;
          ((Fragment)localObject).mTag = str2;
          ((Fragment)localObject).mInLayout = true;
          ((Fragment)localObject).mFragmentManager = this.mFragments;
          ((Fragment)localObject).onInflate(this, paramAttributeSet, ((Fragment)localObject).mSavedFragmentState);
          this.mFragments.addFragment((Fragment)localObject, true);
        }
      }
      while (true)
      {
      ...
      label534: if (j != 0)
        ((Fragment)localObject).mView.setId(j);
  ...
  public boolean onPreparePanel(int paramInt, View paramView, Menu paramMenu)
  {
    ...
    if ((paramInt == 0) && (paramMenu != null))
    {
      ...
      {
        this.mOptionsMenuInvalidated = bool;
        paramMenu.clear();
