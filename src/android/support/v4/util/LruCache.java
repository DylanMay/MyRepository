...
public class LruCache<K, V>
{
  ...
  private void trimToSize(int paramInt)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 68	android/support/v4/util/LruCache:size	I
    //   6: iflt +20 -> 26
    //   9: aload_0
    //   10: getfield 39	android/support/v4/util/LruCache:map	Ljava/util/LinkedHashMap;
    //   13: invokevirtual 72	java/util/LinkedHashMap:isEmpty	()Z
    //   16: ifeq +48 -> 64
    //   19: aload_0
    //   20: getfield 68	android/support/v4/util/LruCache:size	I
    //   23: ifeq +41 -> 64
    ...
    //   37: aload_0
    //   38: invokevirtual 76	java/lang/Object:getClass	()Ljava/lang/Class;
    //   41: invokevirtual 81	java/lang/Class:getName	()Ljava/lang/String;
    ...
    //   63: athrow
    //   64: aload_0
    //   65: getfield 68	android/support/v4/util/LruCache:size	I
    //   68: iload_1
    //   69: if_icmple +13 -> 82
    //   72: aload_0
    //   73: getfield 39	android/support/v4/util/LruCache:map	Ljava/util/LinkedHashMap;
    //   76: invokevirtual 72	java/util/LinkedHashMap:isEmpty	()Z
    //   79: ifeq +6 -> 85
    //   82: aload_0
    //   83: monitorexit
    //   84: return
    //   85: aload_0
    //   86: getfield 39	android/support/v4/util/LruCache:map	Ljava/util/LinkedHashMap;
    //   89: invokevirtual 87	java/util/LinkedHashMap:entrySet	()Ljava/util/Set;
    //   92: invokeinterface 93 1 0
    //   97: invokeinterface 99 1 0
    //   102: checkcast 101	java/util/Map$Entry
    //   105: astore_3
    //   106: aload_3
    //   107: invokeinterface 104 1 0
    //   112: astore 4
    //   114: aload_3
    //   115: invokeinterface 107 1 0
    //   120: astore 5
    //   122: aload_0
    //   123: getfield 39	android/support/v4/util/LruCache:map	Ljava/util/LinkedHashMap;
    //   126: aload 4
    //   128: invokevirtual 111	java/util/LinkedHashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   131: pop
    //   132: aload_0
    //   133: aload_0
    //   134: getfield 68	android/support/v4/util/LruCache:size	I
    //   137: aload_0
    //   138: aload 4
    //   140: aload 5
    //   142: invokespecial 113	android/support/v4/util/LruCache:safeSizeOf	(Ljava/lang/Object;Ljava/lang/Object;)I
    //   145: isub
    //   146: putfield 68	android/support/v4/util/LruCache:size	I
    //   149: aload_0
    //   150: iconst_1
    //   151: aload_0
    //   152: getfield 115	android/support/v4/util/LruCache:evictionCount	I
    //   155: iadd
    //   156: putfield 115	android/support/v4/util/LruCache:evictionCount	I
    //   159: aload_0
    //   160: monitorexit
    //   161: aload_0
    //   162: iconst_1
    ...
    //   165: aload 5
    //   167: aconst_null
    //   168: invokevirtual 119	android/support/v4/util/LruCache:entryRemoved	(ZLjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    //   171: goto -171 -> 0
    //
    // Exception table:
    //   from	to	target	type
