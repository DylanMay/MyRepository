  ...
  implements ViewPager.Decor
{
  ...
  static
  {
    ...
    arrayOfInt[1] = 16842904;
    arrayOfInt[2] = 16842901;
  }
  ...
  void updateText(int paramInt, PagerAdapter paramPagerAdapter)
  {
    ...
    label221: for (CharSequence localCharSequence2 = paramPagerAdapter.getPageTitle(paramInt); ; localCharSequence2 = null)
    {
