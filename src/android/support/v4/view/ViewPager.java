...
public class ViewPager extends ViewGroup
{
  ...
  public boolean beginFakeDrag()
  {
    ...
    while (true)
    {
      ...
      MotionEvent localMotionEvent = MotionEvent.obtain(l, l, i, 0.0F, 0.0F, i);
  ...
  void dataSetChanged()
  {
    ...
    int k;
    int m;
    label38: ItemInfo localItemInfo;
    int n;
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (i5 < i)
    {
      ...
      while (true)
      {
        ...
        break label212;
        label379: ItemInfo localItemInfo = infoForChild(localView);
      ...
      if (localView2.getVisibility() != 8)
      {
        ...
        if ((localLayoutParams2 != null) && (localLayoutParams2.isDecor))
        {
          ...
          label216: if (i6 == 0)
            break label277;
          i4 = 1073741824;
          label226: localView2.measure(View.MeasureSpec.makeMeasureSpec(i, i4), View.MeasureSpec.makeMeasureSpec(j, i5));
          if (i6 == 0)
            break label290;
  ...
  protected boolean onRequestFocusInDescendants(int paramInt, Rect paramRect)
  {
    ...
    label105: label115: for (boolean bool = true; ; bool = false)
    {
      return bool;
      j = i + -1;
      k = -1;
    ...
    while (true)
    {
      ...
      if (this.mIsBeingDragged)
      {
        ...
        if (f3 < f4)
        {
          ...
          {
            float f7 = -f3;
            bool2 = this.mLeftEdge.onPull(f7 / i1);
          }
          f3 = f4;
        }
        while (true)
        {
          ...
          if (f3 > f5)
          {
            ...
            {
              float f6 = f3 - f5;
              bool2 = this.mRightEdge.onPull(f6 / i1);
            }
            f3 = f5;
          }
        }
  ...
  void populate()
  {
    if (this.mAdapter == null)
      break label7;
    label7: label396: label529: label533: 
    while (true)
    {
      return;
      if ((!this.mPopulatePending) && (getWindowToken() != null))
      {
        ...
        if (n < this.mItems.size())
        {
          ...
          while (true)
          {
            ...
            if ((m < k) && (localItemInfo4.position > j))
            {
              ...
              if (i6 < j)
                i6 = j;
              while ((i6 <= k) && (i6 < localItemInfo4.position))
              {
                addNewItem(i6, n);
                i6++;
                n++;
        ...
        label318: ItemInfo localItemInfo1 = null;
        int i2 = 0;
        label324: Object localObject;
        View localView1;
        ...
        else
        {
          ...
          localPagerAdapter.setPrimaryItem(this, i3, localObject);
          this.mAdapter.finishUpdate(this);
          if (!hasFocus())
            break;
  ...
  void setCurrentItemInternal(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      else
      {
        ...
        label249: if ((bool) && (this.mOnPageChangeListener != null))
          this.mOnPageChangeListener.onPageSelected(paramInt1);
        if ((bool) && (this.mInternalPageChangeListener != null))
          this.mInternalPageChangeListener.onPageSelected(paramInt1);
        completeScroll();
