...
public class FabButton extends Button
{
  ...
  public FabButton(Context paramContext)
  {
    super(paramContext);
    init();
  }

  public FabButton(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    init();
  }

  public FabButton(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
 ...
 * Qualified Name:     com.fab.views.FabButton
