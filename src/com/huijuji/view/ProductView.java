...
public class ProductView extends LinearLayout
{
  ...
  public ProductView(Context paramContext)
  {
    super(paramContext);
    init();
  }

  public ProductView(Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  private void init()
  {
    if (!isInEditMode())
    {
      View localView = inflate(getContext(), 2130903082, null);
      ...
      this.prodName.setFont("HelveticaNeu_bold.ttf");
      this.fabPrice.setFont("HelveticaNeu_bold.ttf");
      this.fab.setFont("HelveticaNeu_bold.ttf");
      this.originalPrice.setFont("HelveticaNeu_bold.ttf");
 ...
 * Qualified Name:     com.fab.views.ProductView
